...
RVIZ_CONFIG="${RVIZ_CONFIG:-${ROOT_DIR}/ros2_ws/src/zcw_cable_perception/rviz/two_vehicle_dry_run_overlay.rviz}"
...
RVIZ_LOG="${LOG_DIR}/two_vehicle_dry_run_rviz_${STAMP}.log"
SCREENSHOT_FILE="${SCREENSHOT_DIR}/two_vehicle_dry_run_overlay_${STAMP}.png"
...
cleanup() {
  ...
  pkill -TERM -f "rviz2.*two_vehicle_dry_run_overlay.rviz" >/dev/null 2>&1 || true
