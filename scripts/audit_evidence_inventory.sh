...
required_evidence=(
  "phase_a_bridge_state|data/logs/px4_bridge_dry_run_state_echo_20260603_190805.log|scripts/verify_px4_bridge_dry_run_isolation.sh"
  "phase_a_bridge_rviz|data/screenshots/px4_bridge_dry_run_rviz_overlay_20260603_191816.png|scripts/capture_px4_bridge_dry_run_rviz_overlay.sh"
  "readonly_frame_alignment|data/results/px4_gazebo_frame_alignment_20260603_194311/px4_gazebo_frame_alignment_20260603_194311.txt|scripts/verify_px4_gazebo_readonly_frame_alignment.sh"
  "offboard_gate_summary|data/results/cable_offboard_gate_dry_run_20260604_085746/cable_offboard_gate_dry_run_20260604_085746.txt|scripts/verify_cable_offboard_gate_dry_run.sh"
  "offboard_gate_forbidden_publishers|data/logs/cable_offboard_gate_forbidden_publishers_20260604_085746.log|scripts/verify_cable_offboard_gate_dry_run.sh"
  "offboard_gate_rviz_summary|data/results/cable_offboard_gate_rviz_overlay_20260604_090442/cable_offboard_gate_rviz_overlay_20260604_090442.txt|scripts/capture_cable_offboard_gate_dry_run_rviz_overlay.sh"
  "offboard_gate_rviz_screenshot|data/screenshots/cable_offboard_gate_dry_run_rviz_overlay_20260604_090442.png|scripts/capture_cable_offboard_gate_dry_run_rviz_overlay.sh"
  "offset_path_csv|data/results/catenary_offset_yz_zbin2_20260603_135000/depth_camera_motion_catenary_offset_yz_zbin2_offset_path_20260603_125948.csv|scripts/audit_catenary_fit.sh then scripts/audit_offset_path.sh"
