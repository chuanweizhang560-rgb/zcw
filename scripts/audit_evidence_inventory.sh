...
required_evidence=(
  ...
  "offboard_gate_rviz_summary_refresh|data/results/cable_offboard_gate_rviz_overlay_20260617_171815/cable_offboard_gate_rviz_overlay_20260617_171815.txt|scripts/capture_cable_offboard_gate_dry_run_rviz_overlay.sh"
  "offboard_gate_rviz_screenshot_refresh|data/screenshots/cable_offboard_gate_dry_run_rviz_overlay_20260617_171815.png|scripts/capture_cable_offboard_gate_dry_run_rviz_overlay.sh"
  "cable_active_readiness_snapshot_summary|data/results/cable_active_readiness_snapshot_20260617_172343/cable_active_readiness_snapshot_20260617_172343.txt|scripts/audit_cable_active_readiness_snapshot.sh"
  ...
  "cable_line_segment_coverage|data/results/cable_line_segment_coverage_20260617_085604/cable_line_segment_coverage_20260617_085604.txt|scripts/audit_cable_line_segment_coverage.sh"
  ...
  "cable_surface_current_acceptance|data/results/cable_surface_current_acceptance_20260617_163650/cable_surface_current_acceptance_20260617_163650.txt|scripts/audit_cable_surface_current_acceptance.sh"
  "cable_multiview_surface_occlusion|data/results/cable_multiview_surface_occlusion_offline_20260617_162441/cable_multiview_surface_occlusion_offline_20260617_162441.txt|scripts/audit_cable_multiview_surface_occlusion_offline.sh"
  "cable_fourview_surface_union|data/results/cable_fourview_surface_union_offline_20260618_131943/cable_fourview_surface_union_offline_20260618_131943.txt|scripts/audit_cable_fourview_surface_union_offline.sh"
  "cable_fourview_attitude_feasibility|data/results/cable_fourview_attitude_feasibility_20260618_132059/cable_fourview_attitude_feasibility_20260618_132059.txt|scripts/audit_cable_fourview_attitude_feasibility.sh"
  "cable_fourview_surface_occlusion|data/results/cable_fourview_surface_occlusion_offline_20260618_132716/cable_fourview_surface_occlusion_offline_20260618_132716.txt|scripts/audit_cable_fourview_surface_occlusion_offline.sh"
  "cable_fourview_mount_strategy|data/results/cable_fourview_mount_strategy_20260618_133231/cable_fourview_mount_strategy_20260618_133231.txt|scripts/audit_cable_fourview_mount_strategy.sh"
  "cable_aerialcore_gui_screenshot|data/screenshots/px4_aerialcore_danube_wires_gui_20260617_162903.png|scripts/capture_px4_aerialcore_world_gui.sh"
  ...
  "current_evidence_matrix|data/results/current_evidence_matrix_20260617_161225/current_evidence_matrix_20260617_161225.txt|scripts/audit_current_evidence_matrix.sh"
...
regeneration_commands=(
  ...
  "scripts/audit_cable_line_segment_coverage.sh"
  "scripts/audit_cable_acceptance_threshold_contract.sh"
  "scripts/audit_cable_surface_current_acceptance.sh"
  "scripts/audit_cable_multiview_surface_occlusion_offline.sh"
  "scripts/audit_cable_fourview_surface_occlusion_offline.sh"
  "scripts/audit_cable_fourview_mount_strategy.sh"
