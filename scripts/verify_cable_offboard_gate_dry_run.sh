...
RESULT_DIR="${RESULT_ROOT}/cable_offboard_gate_dry_run_${STAMP}"

AGENT_LOG="${LOG_DIR}/cable_offboard_gate_agent_${STAMP}.log"
PX4_LOG="${LOG_DIR}/cable_offboard_gate_px4_${STAMP}.log"
PX4_WRAPPER_LOG="${PX4_LOG}.wrapper"
PUBLISHER_LOG="${LOG_DIR}/cable_offboard_gate_publisher_${STAMP}.log"
SAFETY_LOG="${LOG_DIR}/cable_offboard_gate_safety_${STAMP}.log"
DRY_RUN_LOG="${LOG_DIR}/cable_offboard_gate_dry_run_candidate_${STAMP}.log"
BRIDGE_LOG="${LOG_DIR}/cable_offboard_gate_bridge_${STAMP}.log"
GATE_LOG="${LOG_DIR}/cable_offboard_gate_node_${STAMP}.log"
TOPIC_LIST_LOG="${LOG_DIR}/cable_offboard_gate_topic_list_${STAMP}.log"
TYPES_LOG="${LOG_DIR}/cable_offboard_gate_types_${STAMP}.log"
FORBIDDEN_LOG="${LOG_DIR}/cable_offboard_gate_forbidden_topics_${STAMP}.log"
FORBIDDEN_PUBLISHERS_LOG="${LOG_DIR}/cable_offboard_gate_forbidden_publishers_${STAMP}.log"
STATE_ECHO_LOG="${LOG_DIR}/cable_offboard_gate_state_echo_${STAMP}.log"
ALLOWED_ECHO_LOG="${LOG_DIR}/cable_offboard_gate_allowed_echo_${STAMP}.log"
APPROVED_NED_ECHO_LOG="${LOG_DIR}/cable_offboard_gate_approved_ned_echo_${STAMP}.log"
SUMMARY_FILE="${RESULT_DIR}/cable_offboard_gate_dry_run_${STAMP}.txt"
...
{
  echo "decision=accepted_cable_offboard_gate_dry_run_smoke"
...
echo "Cable offboard gate dry-run smoke completed."
