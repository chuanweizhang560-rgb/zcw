...
check_pair "MIN_OCCLUSION_CLEAR_COVERAGE" 'MIN_OCCLUSION_CLEAR_COVERAGE="${MIN_OCCLUSION_CLEAR_COVERAGE:-0.65}"' '| Occlusion-clear normal-filtered coverage | `MIN_OCCLUSION_CLEAR_COVERAGE` | `0.65` | `0.708904000` |'
check_pair "MIN_OCCLUSION_BAND_COVERAGE" 'MIN_OCCLUSION_BAND_COVERAGE="${MIN_OCCLUSION_BAND_COVERAGE:-0.55}"' '| Occlusion-clear weakest height-band coverage | `MIN_OCCLUSION_BAND_COVERAGE` | `0.55` | `0.593750000` |'
