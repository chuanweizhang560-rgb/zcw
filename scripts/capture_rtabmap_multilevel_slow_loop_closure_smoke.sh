...
export OFFBOARD_LAUNCH_FILE="${OFFBOARD_LAUNCH_FILE:-single_vehicle_wind_turbine_multilevel_slow_loop_closure_smoke.launch.py}"
export MIN_WAYPOINT_ADVANCEMENTS="${MIN_WAYPOINT_ADVANCEMENTS:-120}"
export MOTION_SETTLE_SEC="${MOTION_SETTLE_SEC:-360}"
export PX4_TIMEOUT_SEC="${PX4_TIMEOUT_SEC:-480}"
