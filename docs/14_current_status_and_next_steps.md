...
- Add independent map-to-ground-truth error metrics before claiming SLAM completion; keep RTAB-Map loop closure as a smoke-level integration result, not final localization accuracy.
