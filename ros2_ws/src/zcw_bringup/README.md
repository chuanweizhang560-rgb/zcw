...
- `single_vehicle_wind_turbine_multilevel_slow_loop_closure_smoke.launch.py`：15m 半径、3 个高度层、每层 2 圈重复的慢速 wind orbit，用于同时审计 RTAB-Map 闭环证据和多高度覆盖；不替代默认规则 baseline。
